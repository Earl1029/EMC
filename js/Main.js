...
const archives = [
    // 1. My Heart Is You're
    {
        ...
        cast: [
            {
                role: "Male Lead",
                name: "Andrei B. Salamera as Marvin",
                image: "assets/Casts & Crews/Salamera.svg"
            },
            {
                role: "Female Lead",
                name: "Jane Rose T. Tatoy as Angela",
                image: "assets/Casts & Crews/Tatoy.svg"
            },
            {
                role: "Director",
                name: "Allan Dave Pocdol",
                image: "assets/Casts & Crews/Pocdol.svg"
            },
            {
                role: "Main Antagonist",
                name: "Kublai Janarl C. Aguda as Gun man",
                image: "assets/Casts & Crews/Aguda.svg"
            },
            {
                role: "Side Character",
                name: "James Lloyd A. Hernandez as the Doctor/Rallyist",
                image: "assets/Casts & Crews/Hernandez.svg"
            },
            {
                role: "Side Character",
                name: "Earl John E. Ebalde as the Doctor/Rallyist",
                image: "assets/Casts & Crews/Ebalde.svg"
            },
            {
                role: "Side Character",
                name: "Jansel Kurt G. Ramirez as the Doctor/Rallyist",
                image: "assets/Casts & Crews/Ramirez.svg"
            },
            {
                role: "Cameraman / Side Character",
                name: "John Mathew S. Donato as the Doctor/Rallyist",
                image: "assets/Casts & Crews/Donato.svg"
            },
            {
                role: "Side Character",
                name: "Henlyn May D. Mateo as the Doctor/Rallyist",
                image: "assets/Casts & Crews/Mateo.svg"
            },
            {
                role: "Side Character",
                name: " Jarod Ivan G. Carritero as the Doctor/Rallyist",
                image: "assets/Casts & Crews/Carritero.svg"
            }
        ],
    ...
    // 2. The Good, Bad and The Devil
    {
        ...
        cast: [
            {
                role: "Director/Main Character",
                name: " Allan Dave O. Pocdol as Andrew",
                image: "assets/Casts & Crews/Pocdol.svg"
            },
            {
                role: "Dubbing /Acting Director",
                name: "Joshua Ezekiel C. Bolofer",
                image: "assets/Casts & Crews/Bolofer.svg"
            },
            {
                role: "Main Character /BGM Singer",
                name: "Lhance Dhanielle C. Avendaño as Daniel",
                image: "assets/Casts & Crews/Avendaño.svg"
            },
            {
                role: "Main Character",
                name: "Jaydiel D. Furiscal as Paolo",
                image: "assets/Casts & Crews/Furiscal.svg"
            },
            {
                role: "Main Character",
                name: "Joseph Roy L. Laganzo as Ryan",
                image: "assets/Casts & Crews/Laganzo.svg"
            },
            {
                role: "Main Character",
                name: "Margarette Karylle F. De Luna as Bea ",
                image: "assets/Casts & Crews/DeLuna.svg"
            },
            {
                role: "Main Character /Scriptwriter",
                name: "Nadezhda A. Peñamante as Mika",
                image: "assets/Casts & Crews/Peñamante.svg"
            },
            {
                role: "Main Character",
                name: "Noah John A. Morada as Leo",
                image: "assets/Casts & Crews/Morada.svg"
            },
            {
                role: "Main Character",
                name: "James Lloyd A. Hernandez as Marco",
                image: "assets/Casts & Crews/Hernandez.svg"
            },
            {
                role: "Main Character",
                name: "Kim Ezekiel S. Calderon as Chris",
                image: "assets/Casts & Crews/Calderon.svg"
            },
            {
                role: "Main Character",
                name: "Kublai Janarl C. Aguda as Enzo",
                image: "assets/Casts & Crews/Aguda.svg"
            },
            {
                role: "Main Character",
                name: "Andrei B. Salamera as Lucas",
                image: "assets/Casts & Crews/Salamera.svg"
            },
            {
                role: "Anti-Hero",
                name: "Andrea P. Egana as Clarissa",
                image: "assets/Casts & Crews/Egana.svg"
            },
            {
                role: "Main Character",
                name: "Clark Stephen C. Vicente as Gabriel",
                image: "assets/Casts & Crews/Vicente.svg"
            },
            {
                role: "Main Antagonist",
                name: "Crylle Rhys D. Yuipco as Mayor Luis",
                image: "assets/Casts & Crews/Yuipco.svg"
            },
            {
                role: "Secondary Antagonist",
                name: "Arr Chile Andrhei P. Evangelista as Dennis",
                image: "assets/Casts & Crews/Evangelista.svg"
            },
            {
                role: "Subtitles",
                name: "Rainier D. Panganiban",
                image: "assets/Casts & Crews/Panganiban.svg"
            },
            {
                role: "CGI /Visual Artist",
                name: "Emmanuel Jirah S. Delfino",
                image: "assets/Casts & Crews/Delfino.svg"
            }
            ,{
                role: "Colorist, Title Editor",
                name: "Jhon Carlo D. Paglomutan",
                image: "assets/Casts & Crews/Paglomutan.svg"
            }
            ,{
                role: "Sound Director",
                name: "Earl John E. Ebalde",
                image: "assets/Casts & Crews/Ebalde.svg"
            },
            {
                role: "Audio Director",
                name: "Henlyn May D. Mateo",
                image: "assets/Casts & Crews/Mateo.svg"
            }
    ...
    // 3. Oversharing
    {
        ...
        cast: [
            ...
            {
                role: "Main Character",
                name: "James Lloyd A. Hernandez as IceJames",
                image: "assets/Casts & Crews/Hernandez.svg"
            },
            {
                role: "Side Character /Sponsor",
                name: "Emmanuel Jirah S. Delfino as DJ",
                image: "assets/Casts & Crews/Delfino.svg"
            },
            {
                role: "Sound Director /Side Character",
                name: "Earl John E. Ebalde as Stalker 1",
                image: "assets/Casts & Crews/Ebalde.svg"
            },
            {
                role: "Side Character",
                name: "John Mathew S. Donato as Stalker 2",
                image: "assets/Casts & Crews/Donato.svg"
            }
    ...
    // 5. Tag Ulan
    {
        ...
        cast: [
            ...
            {
                role: "LeadMain Character",
                name: "James Lloyd A. Hernandez as the Student",
                image: "assets/Casts & Crews/Hernandez.svg"
            },
            {
                role: "Side Character",
                name: "Kublai Janarl C. Aguda as Classmate",
                image: "assets/Casts & Crews/Aguda.svg"
            },
            {
                role: "Antagonist",
                name: " Jarod Ivan G. Carritero as Prof",
                image: "assets/Casts & Crews/Carritero.svg"
            }
        ],
    ...
    // 7. Cry Machine
    {
        ...
        cast: [
            {
                role: "Director / Male Lead",
                name: "Allan Dave Pocdol as Theo",
                image: "assets/Casts & Crews/Pocdol.svg"
            },
            {
                role: "Female Lead /Female Lead",
                name: "Angel Grace S. Vertudazo as Elli",
                image: "assets/Casts & Crews/Vertudazo.svg"
            },
            {
                role: "Main Antagonist /Sound Designer",
                name: "Earl John E. Ebalde as Omniel",
                image: "assets/Casts & Crews/Ebalde.svg"
            },
            {
                role: "Main Rival /Sound Designer",
                name: "Kublai Janarl C. Aguda as Victor",
                image: "assets/Casts & Crews/Aguda.svg"
            },
            {
                role: "Supporting Character",
                name: "Nadezhda A. Peñamante as Amara",
                image: "assets/Casts & Crews/Peñamante.svg"
            },
            {
                role: "Supporting Character",
                name: "Ryan D. Bacalangco as Rey",
                image: "assets/Casts & Crews/Bacalangco.svg"
            },
            {
                role: "Supporting Villain",
                name: "John Kevin D. Gandeza as Agent One",
                image: "assets/Casts & Crews/Gandeza.svg"
            },
            {
                role: "Supporting Villain",
                name: "Arr Chile Andrhei P. Evangelista as Agent Hawk",
                image: "assets/Casts & Crews/Evangelista.svg"
            },
            {
                role: "Supporting Villain",
                name: "Joseph Roy L. Laganzo as Agent Muscle",
                image: "assets/Casts & Crews/Laganzo.svg"
            },
            {
                role: "Supporting Villain",
                name: "Nhieone Dela Cruz as Gangster 1",
                image: "assets/Casts & Crews/DelaCruz.svg"
            },
            {
                role: "Supporting Villain/Propsman",
                name: "Noah John A. Morada as Agent2",
                image: "assets/Casts & Crews/Morada.svg"
            },
            {
                role: "Supporting Villain",
                name: "Kim Ezekiel S. Calderon as Gangster 2",
                image: "assets/Casts & Crews/Calderon.svg"
            },
            {
                role: "Supporting Villain",
                name: "Crylle Rhys D. Yuipco as Agent 3",
                image: "assets/Casts & Crews/Yuipco.svg"
            },
            {
            ...
            {
                role: "Assistant Editor /Subtitle",
                name: "Jhon Carlo D. Paglomutan",
                image: "assets/Casts & Crews/Paglomutan.svg"
            }
        ],
    ...
    // 9. Lost Signal
    {
        ...
        cast: [
            {
                role: "Main Character",
                name: "Joseph Roy L. Laganzo as Sol",
                image: "assets/Casts & Crews/Laganzo.svg"
            },
            {
                role: "Main Character",
                name: "Clark Stephen C. Vicente as Luna",
                image: "assets/Casts & Crews/Vicente.svg"
            },
            {
                role: "Director /Scriptwriter",
            ...
            {
                role: "Side Character",
                name: "Ryan D. Bacalangco as Student 1",
                image: "assets/Casts & Crews/Bacalangco.svg"
            },
            {
                role: "Side Character",
            ...
            {
                role: "Side Character",
                name: "Nhieone Dela Cruz as Student 3",
                image: "assets/Casts & Crews/DelaCruz.svg"
            },
            {
                role: "Side Character",
                name: "John Kevin D. Gandeza",
                image: "assets/Casts & Crews/Gandeza.svg"
            },
            {
                role: "Editor/Camera man",
                name: "Lhance Dhanielle C. Avendaño as Daniel",
                image: "assets/Casts & Crews/Avendaño.svg"
            },
            {
                role: "Sound Editor /Camera man",
                name: "Emmanuel Jirah S. Delfino",
                image: "assets/Casts & Crews/Delfino.svg"
            }
        ],
    ...
    // 10. Placeholder Movie 10
    {
        ...
        cast: [
            {
                role: "Main Character",
                name: "Andrei B. Salamera as C2 lover",
                image: "assets/Casts & Crews/Salamera.svg"
            },
            {
                role: "Sponsor/Director",
                name: "Earl John E. Ebalde",
                image: "assets/Casts & Crews/Ebalde.svg"
            },
            {
    ...
    // 11. Placeholder Movie 11
    {
        ...
        cast: [
            {
                role: "Male Lead",
                name: "Jaydiel D. Furiscal as the Jaydiel",
                image: "assets/Casts & Crews/Furiscal.svg"
            },
            {
                role: "Female Lead",
                name: "Margarette Karylle F. De Luna as Karylle",
                image: "assets/Casts & Crews/DeLuna.svg"
            },
            {
                role: "Director",
    ...
    // 12. Placeholder Movie 12
    {
        ...
        cast: [
            {
                role: "Main Character",
                name: "Ryan D. Bacalangco as the House Owner",
                image: "assets/Casts & Crews/Bacalangco.svg"
            },
            {
                role: "Antagonist",
                name: "John Kevin D. Gandeza as the Burglar",
                image: "assets/Casts & Crews/Gandeza.svg"
            },
            {
                role: "Director",
                name: "Lhance Dhanielle C. Avendaño ",
                image: "assets/Casts & Crews/Avendaño.svg"
            },
            {
                role: "Camera Man",
                name: "Clark Stephen C. Vicente",
                image: "assets/Casts & Crews/Vicente.svg"
            }
        ],
    ...
    // 13. Placeholder Movie 13
    {
        ...
        cast: [
            {
                role: "Female Lead",
                name: "Jane Rose T. Tatoy as Jade",
                image: "assets/Casts & Crews/Tatoy.svg"
            },
            {
                role: "Antagonist",
                name: "Arr Chile Andrhei P. Evangelista as Clark",
                image: "assets/Casts & Crews/Evangelista.svg"
            },
            {
                role: "Boom Mic Operator",
                name: "Nhieone Dela Cruz as Clark\’s brother",
                image: "assets/Casts & Crews/DelaCruz.svg"
            },
            {
                role: "Supporting Character",
            ...
            {
                role: "Supporting Character",
                name: "Crylle Rhys D. Yuipco as Friend 2",
                image: "assets/Casts & Crews/Yuipco.svg"
            }
        ],
    ...
    // 14. Placeholder Movie 14
    {
        ...
        cast: [
            {
                role: "Main Character",
                name: "Joseph Roy L. Laganzo as Roy",
                image: "assets/Casts & Crews/Laganzo.svg"
            },
            {
                role: "Director/Supporting Character",
                name: "Angel Grace S. Vertudazo as Friend 1",
                image: "assets/Casts & Crews/Vertudazo.svg"
            },
            {
                role: "Supporting Character",
                name: "Rainier D. Panganiban as Friend 2",
                image: "assets/Casts & Crews/Panganiban.svg"
            },
            {
    ...
    // 15. Placeholder Movie 15
    {
        ...
        cast: [
            ...
            {
                role: "Main Character",
                name: "Jaydiel D. Furiscal as Jaydiel",
                image: "assets/Casts & Crews/Furiscal.svg"
            },
            {
                role: "Director",
            ...
            {
                role: "Receptionist /Side Character",
                name: "Andrea P. Egana as Friend 1",
                image: "assets/Casts & Crews/Egana.svg"
            },
            {
                role: "Side Character",
                name: "Nadezhda A. Peñamante as Friend 2",
                image: "assets/Casts & Crews/Peñamante.svg"
            },
            {
                role: "Side Character",
                name: "Noah John A. Morada as Friend 3",
                image: "assets/Casts & Crews/Morada.svg"
            },
            {
                role: "Side Character",
                name: "Crylle Rhys D. Yuipcoas Friend 3",
                image: "assets/Casts & Crews/Yuipco.svg"
            },
            {
                role: "Side Character /Sponsor",
                name: "Kim Ezekiel S. Calderon as Friend 4",
                image: "assets/Casts & Crews/Calderon.svg"
            },
            {
                role: "Editor",
    ...
    // 16. Placeholder Movie 16
    {
        ...
        cast: [
            ...
            {
                role: "Male Lead",
                name: "Kim Ezekiel S. Calderon",
                image: "assets/Casts & Crews/Calderon.svg"
            },
            {
                role: "Director",
                name: "Nadezhda A. Peñamante",
                image: "assets/Casts & Crews/Peñamante.svg"
            },
            {
                role: "Camera man",
                name: "Noah John A. Morada",
                image: "assets/Casts & Crews/Morada.svg"
            }
        ],
    ...
    // 17. Placeholder Movie 17
    {
        ...
        cast: [
            {
                role: "Male Lead 1",
                name: "Jaydiel D. Furiscal as Marco Manlangit",
                image: "assets/Casts & Crews/Furiscal.svg"
            },
            {
                role: "Male Lead 2",
                name: "James Lloyd A. Hernandez as Jay Sumampo",
                image: "assets/Casts & Crews/Hernandez.svg"
            },
            {
                role: "Male 3",
                name: "Lhance Dhanielle C. Avendaño as Alfred Sta.Cruz",
                image: "assets/Casts & Crews/Avendaño.svg"
            },
            {
                role: "Female Lead 1",
                name: "Andrea P. Egana as Thea",
                image: "assets/Casts & Crews/Egana.svg"
            },
            {
                role: "Female Lead 2",
                name: "Margarette Karylle F. De Luna as Hannah",
                image: "assets/Casts & Crews/DeLuna.svg"
            },
            {
                role: "Female Lead 3",
                name: "Jane Rose T. Tatoy as Abby",
                image: "assets/Casts & Crews/Tatoy.svg"
            },
            {
                role: "Director",
            ...
            {
                role: "Side Character",
                name: "Andrei B. Salamera as Jomar",
                image: "assets/Casts & Crews/Salamera.svg"
            },
            {
                role: "Main Character",
                name: "Jansel Kurt G. Ramirez as Teacher",
                image: "assets/Casts & Crews/Ramirez.svg"
            },
            {
                role: "Anti-hero",
                name: "Clark Stephen C. Vicente as Flower Boy",
                image: "assets/Casts & Crews/Vicente.svg"
            },
            {
                role: "Extra",
                name: "Jarod Ivan G. Carritero",
                image: "assets/Casts & Crews/Carritero.svg"
            },
            {
                role: "Audio Director",
...
function renderSearchHistory() {
    // Removed search history display functionality
}

function hideSearchHistory() {
    // Removed search history functionality
}
...
let discAnimationFrame = null;
let discRotationStart = null;
...
function playVideo(youtubeId) {
    ...
    const embedUrl = youtubeId.startsWith('http')
        ? youtubeId.replace(/(\?|&)autoplay=\d+/g, '').replace(/(\?|&)mute=\d+/g, '')
        : `https://www.youtube.com/embed/${youtubeId}`;
    const isYouTube = embedUrl.includes('youtube.com') || embedUrl.includes('youtu.be');
    const autoplayParam = isYouTube ? 'autoplay=1&mute=1' : 'autoplay=1';
    youtubePlayer.src = `${embedUrl}${embedUrl.includes('?') ? '&' : '?'}${autoplayParam}`;
...
function updateDetailsPage(movie) {
    ...
    detailsPoster.classList.remove('spin-slow');
    detailsPoster.style.animation = 'none';
    detailsPoster.onload = () => {
        restartDiscAnimation();
        detailsPoster.onload = null;
    };
    detailsPoster.src = movie.disc;
    detailsPoster.alt = movie.title;
    if (detailsPoster.complete) {
        restartDiscAnimation();
    }
        ...
        return `
            <div class="cast-member flex-shrink-0">
                ...
                <div class="member-circle">
                    <img src="${member.image}" alt="${member.name}" class="w-full h-full object-cover rounded-full" onerror="this.src='https://via.placeholder.com/80x80/333/666?text=${encodeURIComponent(member.name)}'">
                </div>
...
function animateDisc(timestamp) {
    if (!detailsPoster || !detailsPage || detailsPage.classList.contains('hidden')) return;
    if (discRotationStart === null) discRotationStart = timestamp;
    const elapsed = timestamp - discRotationStart;
    const degrees = (elapsed / 30000) * 360;
    detailsPoster.style.transform = `rotate(${degrees}deg)`;
    discAnimationFrame = requestAnimationFrame(animateDisc);
}

function restartDiscAnimation() {
    if (!detailsPoster) return;
    if (discAnimationFrame) cancelAnimationFrame(discAnimationFrame);
    discRotationStart = null;
    detailsPoster.style.animation = 'none';
    detailsPoster.style.transform = 'rotate(0deg)';
    discAnimationFrame = requestAnimationFrame(animateDisc);
}
...
function showMovieDetails(title = 'Cry Machine') {
    ...
    window.scrollTo(0, 0);
    requestAnimationFrame(restartDiscAnimation);
...
const scrollContainers = document.querySelectorAll('[id$="-row"]');
...
searchInput.addEventListener('input', (e) => {
    ...
    if (term.length > 0) {
        ...
        // Search across all movies (case-insensitive and space-tolerant)
        const normalizedTerm = term.replace(/\s+/g, ''); // Remove all spaces
        const results = archives.filter(p => {
            const normalizedTitle = p.title.toLowerCase().replace(/\s+/g, '');
            const normalizedDesc = p.desc.toLowerCase().replace(/\s+/g, '');
            const normalizedGenre = p.genre.toLowerCase().replace(/\s+/g, '');
            const normalizedDir = p.dir.toLowerCase().replace(/\s+/g, '');
            
            return normalizedTitle.includes(normalizedTerm) ||
                   normalizedDesc.includes(normalizedTerm) ||
                   p.cast.some(c => {
                       const normalizedRole = c.role.toLowerCase().replace(/\s+/g, '');
                       const normalizedName = c.name.toLowerCase().replace(/\s+/g, '');
                       return normalizedRole.includes(normalizedTerm) || normalizedName.includes(normalizedTerm);
                   }) ||
                   p.tags.some(t => t.toLowerCase().replace(/\s+/g, '').includes(normalizedTerm)) ||
                   normalizedGenre.includes(normalizedTerm) ||
                   normalizedDir.includes(normalizedTerm) ||
                   // Also keep original spaced search for exact matches
                   p.title.toLowerCase().includes(term) ||
                   p.desc.toLowerCase().includes(term) ||
                   p.cast.some(c => c.role.toLowerCase().includes(term) || c.name.toLowerCase().includes(term)) ||
        ...
        // Show empty search page instead of going home
        showSearchResults([], '');
    }
});
...
function showSearchResults(results, searchTerm) {
    ...
    if (!searchPage) {
        ...
        searchPage.className = 'min-h-screen bg-[#050505] pt-24 px-[5%] animated-bg page-content';
    ...
    setTimeout(() => {
        if (results.length === 0 && searchTerm.trim() === '') {
            // Empty search - show search prompt
            searchPage.innerHTML = `
                <div class="text-center text-white py-20">
                    <div class="text-6xl mb-4">🔍</div>
                    <h1 class="text-4xl font-bold mb-4">Search Movies</h1>
                    <p class="text-xl text-gray-400 mb-4">Start typing to search through our collection</p>
                    <p class="text-gray-500 mb-8">Search by title, genre, director, cast, or keywords</p>
...
document.getElementById('search-btn').addEventListener('click', () => {
    ...
    // Show search page immediately when button is clicked
    if (term) {
        addToSearchHistory(searchInput.value.trim()); // Store original case for history
        // Perform search directly (case-insensitive and space-tolerant)
        const normalizedTerm = term.replace(/\s+/g, ''); // Remove all spaces
        const results = archives.filter(p => {
            const normalizedTitle = p.title.toLowerCase().replace(/\s+/g, '');
            const normalizedDesc = p.desc.toLowerCase().replace(/\s+/g, '');
        ...
        showSearchResults(results, searchInput.value.trim()); // Show original case in results
    } else {
...
searchInput.addEventListener('focus', () => {
    // Removed recent searches on focus
});
